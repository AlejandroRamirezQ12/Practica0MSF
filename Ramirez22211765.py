...
den = [C*L,C*R,1]
sys = ctrl.tf(num,den)
print("Funcion de transferencia del sistema: sys")
...
Rr = kP*Re
Ce = kD / Rr
print("El valor de la capacitancia propuesta de Cr es de {Cr} Faradios.")
print("El valor de la resistencia de Re es de {Re} ohms.")
print("El valor de la resistencia de Rr es de {Re} ohms.")
print("El valor de la capacitancia de Ce es de {Ce} Faradios. ")

numPID = [Rr*Re*Cr*Ce, Re*Ce+Rr*Cr, 1]
denPID = [Re*Cr,0]
PID = ctrl.tf(numPID,denPID)
print("La funcion de transfderencia del controlador PID es {PID}")
